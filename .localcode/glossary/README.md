...
Use this folder for locale-specific translation guidance that supplements `.localcode/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/localcode/pull/12345

## Do Not Translate (Locale Additions)

- `LocalCode` (preserve casing)
