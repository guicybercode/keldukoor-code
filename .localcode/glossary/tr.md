...
- PR #15835: https://github.com/anomalyco/localcode/pull/15835

## Do Not Translate (Locale Additions)

- `LocalCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `localcode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `LocalCode` in prose, `localcode` only for exact technical identifiers
...
- Avoid changing `localcode` to `LocalCode` inside commands, URLs, package names, or code literals
