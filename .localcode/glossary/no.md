...
- PR #10018: https://github.com/anomalyco/localcode/pull/10018
- PR #12935: https://github.com/anomalyco/localcode/pull/12935

## Do Not Translate (Locale Additions)

- `LocalCode` (preserve casing in prose; keep `localcode` only in commands, package names, paths, or code)
- `LocalCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
