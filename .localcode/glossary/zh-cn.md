...
- PR #13942: https://github.com/anomalyco/localcode/pull/13942

## Do Not Translate (Locale Additions)

- `LocalCode` (preserve casing in prose; keep `localcode` only when it is part of commands, package names, paths, or code)
- `LocalCode Zen`
- `LocalCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `localcode` in prose when referring to the product name; use `LocalCode`
