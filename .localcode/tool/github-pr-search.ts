...
import { tool } from "@localcode/plugin"
...
This tool searches PRs in the anomalyco/localcode repository and returns LLM-friendly results including:
- PR number and title
- Author
