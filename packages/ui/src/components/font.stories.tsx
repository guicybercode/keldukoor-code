...
const docs = `### Overview
Loads LocalCode typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>LocalCode Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>LocalCode Mono Sample</div>
    </div>
  ),
}
