export const dict = {
  ...
  "desktop.menu.help.documentation": "LocalCode Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "LocalCode CLI binary is missing. Try reinstalling the desktop app.",
