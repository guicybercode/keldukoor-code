export const dict = {
  ...
  "desktop.menu.help.documentation": "LocalCode Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "LocalCode CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
