...
const releaseId = process.env.LOCALCODE_RELEASE
if (!releaseId) throw new Error("LOCALCODE_RELEASE is required")

const version = process.env.LOCALCODE_VERSION
if (!releaseId) throw new Error("LOCALCODE_VERSION is required")
...
const targets = [
  { key: "linux-x86_64-deb", asset: "localcode-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "localcode-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "localcode-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "localcode-desktop-linux-aarch64.rpm" },
  { key: "windows-aarch64-nsis", asset: "localcode-desktop-windows-arm64.exe" },
  { key: "windows-x86_64-nsis", asset: "localcode-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "localcode-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "localcode-desktop-darwin-aarch64.app.tar.gz",
  },
]
