...
import { and, Database, eq, isNull, lt, or, sql } from "@localcode/console-core/drizzle/index.js"
import { KeyTable } from "@localcode/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@localcode/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@localcode/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@localcode/console-core/util/date.js"
import { Identifier } from "@localcode/console-core/identifier.js"
import { Billing } from "@localcode/console-core/billing.js"
import { Actor } from "@localcode/console-core/actor.js"
import { WorkspaceTable } from "@localcode/console-core/schema/workspace.sql.js"
import { ZenData } from "@localcode/console-core/model.js"
import { Subscription } from "@localcode/console-core/subscription.js"
import { BlackData } from "@localcode/console-core/black.js"
import { UserTable } from "@localcode/console-core/schema/user.sql.js"
import { ModelTable } from "@localcode/console-core/schema/model.sql.js"
import { ProviderTable } from "@localcode/console-core/schema/provider.sql.js"
...
import { LiteData } from "@localcode/console-core/lite.js"
import { Resource } from "@localcode/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-localcode-session") ?? ""
    const requestId = input.request.headers.get("x-localcode-request") ?? ""
    const projectId = input.request.headers.get("x-localcode-project") ?? ""
    const ocClient = input.request.headers.get("x-localcode-client") ?? ""
    logger.metric({
      is_stream: isStream,
      session: sessionId,
      request: requestId,
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-localcode-request")
          headers.delete("x-localcode-session")
          headers.delete("x-localcode-project")
          headers.delete("x-localcode-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    const billingUrl = `https://localcode.dev/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://localcode.dev/workspace/${authInfo.workspaceID}/members`
