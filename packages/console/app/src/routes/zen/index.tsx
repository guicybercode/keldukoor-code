...
import compareVideo from "../../asset/lander/localcode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/localcode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="localcode:auth" content={loggedin() ? "true" : "false"} />
