...
import desktopAppIcon from "../../asset/lander/localcode-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://localcode.dev/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>localcode.dev/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g localcode")}>
                <code>
                  npm i -g <strong>localcode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g localcode")}>
                <code>
                  bun add -g <strong>localcode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/localcode")}>
                <code>
                  brew install <strong>anomalyco/tap/localcode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S localcode")}>
                <code>
                  paru -S <strong>localcode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask localcode-desktop")}>
                <code>
                  brew install --cask <strong>localcode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
