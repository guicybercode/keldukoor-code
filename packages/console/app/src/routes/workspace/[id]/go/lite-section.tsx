...
import { Database, eq, and, isNull } from "@localcode/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@localcode/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#localcode-go")} target="_blank" rel="noopener noreferrer">
