export const dict = {
  ...
  "dialog.provider.localcode.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.localcode.tagline": "Modelos optimizados y fiables",
  "dialog.provider.localcodeGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por LocalCode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en LocalCode.",
  ...
  "provider.connect.localcodeZen.line1":
    "LocalCode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.localcodeZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.localcodeZen.visit.prefix": "Visita ",
  "provider.connect.localcodeZen.visit.link": "localcode.dev/zen",
  "provider.connect.localcodeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en LocalCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en LocalCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados en localcode.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de LocalCode se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de LocalCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de LocalCode",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (localcode.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, LocalCode no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "LocalCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor LocalCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para LocalCode",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve LocalCode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si LocalCode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de LocalCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia LocalCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de LocalCode.",
