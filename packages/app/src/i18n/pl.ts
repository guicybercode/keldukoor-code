export const dict = {
  ...
  "dialog.provider.localcode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.localcode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.localcodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez LocalCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w LocalCode.",
  ...
  "provider.connect.localcodeZen.line1":
    "LocalCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.localcodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.localcodeZen.visit.link": "localcode.dev/zen",
  "provider.connect.localcodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w LocalCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w LocalCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w localcode.json",
  ...
  "dialog.server.description": "Przełącz serwer LocalCode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja LocalCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu LocalCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (localcode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "LocalCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla LocalCode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd LocalCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy LocalCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw LocalCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania LocalCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji LocalCode.",
