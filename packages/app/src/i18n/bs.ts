export const dict = {
  ...
  "dialog.provider.localcode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.localcode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.localcodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje LocalCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u LocalCode-u.",
  ...
  "provider.connect.localcodeZen.line1":
    "LocalCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.localcodeZen.visit.prefix": "Posjeti ",
  "provider.connect.localcodeZen.visit.link": "localcode.dev/zen",
  "provider.connect.localcodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u LocalCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u LocalCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u localcode.json",
  ...
  "dialog.server.description": "Promijeni na koji se LocalCode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija LocalCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku LocalCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (localcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: LocalCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "LocalCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni LocalCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u LocalCode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako LocalCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li LocalCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu LocalCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se LocalCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju LocalCode-a.",
