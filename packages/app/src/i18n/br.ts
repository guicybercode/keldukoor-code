export const dict = {
  ...
  "dialog.provider.localcode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.localcode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.localcodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo LocalCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no LocalCode.",
  ...
  "provider.connect.localcodeZen.line1":
    "LocalCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.localcodeZen.visit.prefix": "Visite ",
  "provider.connect.localcodeZen.visit.link": "localcode.dev/zen",
  "provider.connect.localcodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no LocalCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no LocalCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em localcode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor LocalCode este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do LocalCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do LocalCode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (localcode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: LocalCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "LocalCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor LocalCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do LocalCode",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o LocalCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o LocalCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o LocalCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o LocalCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do LocalCode.",
