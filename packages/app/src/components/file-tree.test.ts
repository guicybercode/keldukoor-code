...
beforeAll(async () => {
  ...
  mock.module("@localcode/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@localcode/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@localcode/ui/icon", () => ({ Icon: () => null }))
  mock.module("@localcode/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
