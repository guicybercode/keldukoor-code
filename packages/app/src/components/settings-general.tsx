...
import { Switch } from "@localcode/ui/switch"
...
let font: Promise<typeof import("@localcode/ui/font-loader")> | undefined

function loadFont() {
  font ??= import("@localcode/ui/font-loader")
  return font
}
        ...
        <SettingsRow
          ...
          description={
            <>
              ...
              <Link href="https://localcode.dev/docs/themes/">{language.t("common.learnMore")}</Link>
            </>
          }
        >
          <Select
