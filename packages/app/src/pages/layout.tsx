...
import { base64Encode } from "@localcode/util/encode"
import { decode64 } from "@/utils/base64"
import { ResizeHandle } from "@localcode/ui/resize-handle"
import { Button } from "@localcode/ui/button"
import { IconButton } from "@localcode/ui/icon-button"
import { Tooltip } from "@localcode/ui/tooltip"
...
import { Session, type Message } from "@localcode/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@localcode/ui/toast"
...
import { retry } from "@localcode/util/retry"
...
import { useTheme, type ColorScheme } from "@localcode/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://localcode.dev/desktop-feedback")}
      renderPanel={() =>
