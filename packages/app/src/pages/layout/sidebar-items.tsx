import type { Message, Session, TextPart, UserMessage } from "@localcode/sdk/v2/client"
import { Avatar } from "@localcode/ui/avatar"
import { HoverCard } from "@localcode/ui/hover-card"
...
const LOCALCODE_PROJECT_ID = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"
    ...
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      <div class="size-full rounded overflow-clip">
        <Avatar
          fallback={name()}
          src={
            props.project.id === LOCALCODE_PROJECT_ID ? "https://localcode.dev/favicon.svg" : props.project.icon?.override
          }
