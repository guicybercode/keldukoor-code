...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new LocalcodeClient()" to fix this error.`)
    }
    return instance
  }
...
export class Global extends HeyApiClient {
   ...
   * Upgrade localcode
   *
   * Upgrade localcode to the specified version or latest if not specified.
   */
...
export class LocalcodeClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<LocalcodeClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    LocalcodeClient.__registry.set(this, args?.key)
  }
