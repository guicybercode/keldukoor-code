...
Practical reference for new and migrated Effect code in `packages/localcode`.
...
export namespace Foo {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@localcode/Foo") {}
