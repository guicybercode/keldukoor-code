...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@localcode/plugin"
import z from "zod"
...
export namespace ToolRegistry {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@localcode/ToolRegistry") {}
  ...
  export const layer = Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      async function all(custom: Tool.Info[]): Promise<Tool.Info[]> {
        ...
        const question = ["app", "cli", "desktop"].includes(Flag.LOCALCODE_CLIENT) || Flag.LOCALCODE_ENABLE_QUESTION_TOOL
        ...
        return [
          ...
          SkillTool,
          ApplyPatchTool,
          ...(Flag.LOCALCODE_EXPERIMENTAL_LSP_TOOL ? [LspTool] : []),
          ...(cfg.experimental?.batch_tool === true ? [BatchTool] : []),
          ...(Flag.LOCALCODE_EXPERIMENTAL_PLAN_MODE && Flag.LOCALCODE_CLIENT === "cli" ? [PlanExitTool] : []),
          ...custom,
        ]
      }
            ...
            allTools
              .filter((tool) => {
                ...
                if (tool.id === "codesearch" || tool.id === "websearch") {
                  return Flag.LOCALCODE_ENABLE_EXA
                }
