import type { Hooks, PluginInput, Plugin as PluginInstance } from "@localcode/plugin"
...
export namespace Plugin {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@localcode/Plugin") {}
        ...
        Effect.fn("Plugin.state")(function* (ctx) {
          ...
          yield* Effect.promise(async () => {
            ...
            const client = createLocalcodeClient({
              ...
              headers: Flag.LOCALCODE_SERVER_PASSWORD
                ? {
                    Authorization: `Basic ${Buffer.from(`${Flag.LOCALCODE_SERVER_USERNAME ?? "localcode"}:${Flag.LOCALCODE_SERVER_PASSWORD}`).toString("base64")}`,
                  }
                : undefined,
