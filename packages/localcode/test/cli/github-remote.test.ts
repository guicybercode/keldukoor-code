...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/localcode.git")).toEqual({ owner: "sst", repo: "localcode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/localcode")).toEqual({ owner: "sst", repo: "localcode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/localcode.git")).toEqual({ owner: "sst", repo: "localcode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/localcode")).toEqual({ owner: "sst", repo: "localcode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/localcode.git")).toEqual({ owner: "sst", repo: "localcode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/localcode")).toEqual({ owner: "sst", repo: "localcode" })
})
