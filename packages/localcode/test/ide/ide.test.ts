...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders LOCALCODE_CALLER", () => {
    process.env["LOCALCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode LOCALCODE_CALLER", () => {
    process.env["LOCALCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown LOCALCODE_CALLER", () => {
    process.env["LOCALCODE_CALLER"] = "unknown"
