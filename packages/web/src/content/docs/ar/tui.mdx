---
title: TUI
description: استخدام واجهة المستخدم TUI في LocalCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر LocalCode واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل LocalCode إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة LocalCode في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى LocalCode. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من LocalCode. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات LocalCode.
...
استخدم `LOCALCODE_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
