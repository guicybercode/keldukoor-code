---
title: خوادم LSP
description: يتكامل LocalCode مع خوادم LSP لديك.
---

يتكامل LocalCode مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي LocalCode مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `LOCALCODE_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
عندما يفتح localcode ملفا، فإنه:
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات localcode.
