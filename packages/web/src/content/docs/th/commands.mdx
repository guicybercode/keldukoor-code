...
สร้าง `.localcode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ LocalCode:
...
- ระดับผู้ใช้ (Global): `~/.config/localcode/commands/`
- ระดับโปรเจ็กต์: `.localcode/commands/`
...
LocalCode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
