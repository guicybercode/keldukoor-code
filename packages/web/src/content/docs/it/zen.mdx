---
title: Zen
description: Lista curata di modelli fornita da LocalCode.
---
...
LocalCode Zen è una lista di modelli testati e verificati dal team di LocalCode.

:::note
LocalCode Zen è attualmente in beta.
:::

Zen funziona come qualunque altro provider in LocalCode. Accedi a LocalCode Zen e ottieni la tua chiave API. È **completamente opzionale** e non devi usarlo per usare LocalCode.
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con LocalCode.
:::
...
LocalCode Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

LocalCode Zen funziona come qualunque altro provider in LocalCode.

1. Accedi a **<a href={console}>LocalCode Zen</a>**, aggiungi i dettagli di fatturazione e copia la chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona LocalCode Zen e incolla la chiave API.
...
| MiMo V2 Flash Free    | mimo-v2-flash-free    | `https://localcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Nemotron 3 Super Free | nemotron-3-super-free | `https://localcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

Il [model id](/docs/config/#models) nella config di LocalCode usa il formato `localcode/<model-id>`. Per esempio, per GPT 5.3 Codex, useresti `localcode/gpt-5.3-codex` nella config.
...
- MiniMax M2.5 Free è disponibile su LocalCode per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- MiMo V2 Flash Free è disponibile su LocalCode per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Super Free è disponibile su LocalCode per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth gratuito su LocalCode per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato LocalCode Zen per:
...
4. Evitare **lock-in** permettendoti di usarlo con qualunque altro agente di coding e lasciandoti sempre usare anche altri provider con LocalCode.
