---
title: TUI
description: Usando la interfaz de usuario del terminal LocalCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LocalCode proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar LocalCode se inicia TUI para el directorio actual.
...
Cuando utilice LocalCode TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a LocalCode. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de LocalCode. _Alias_: `/quit`, `/q`
...
Esto es independiente de `localcode.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `LOCALCODE_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
