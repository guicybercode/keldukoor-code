...
Crear `.localcode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración LocalCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su LocalCode [config](/docs/config):
...
- Por proyecto: `.localcode/commands/`
...
localcode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
