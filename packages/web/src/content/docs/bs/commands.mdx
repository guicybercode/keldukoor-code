...
Kreiraj `.localcode/commands/test.md`:
...
Možete dodati prilagođene komande kroz LocalCode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom LocalCode [config](/docs/config):
...
- Globalno: `~/.config/localcode/commands/`
- Po projektu: `.localcode/commands/`
...
LocalCode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
