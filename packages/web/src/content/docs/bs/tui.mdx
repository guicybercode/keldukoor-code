---
title: TUI
description: Korištenje korisničkog interfejsa LocalCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LocalCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje LocalCode pokreće TUI za trenutni direktorij.
...
Kada koristite LocalCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u LocalCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz LocalCode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `localcode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `LOCALCODE_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
