---
title: TUI
description: Usando a interface de usuário de terminal localcode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O localcode fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar localcode inicia o TUI para o diretório atual.
...
Ao usar o TUI do localcode, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao localcode. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do localcode. _Aliases_: `/quit`, `/q`
...
Isso é separado do `localcode.json`, que configura o comportamento do servidor/runtime.
...
Use `LOCALCODE_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
