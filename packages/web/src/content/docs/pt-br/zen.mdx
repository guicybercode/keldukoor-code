---
title: Zen
description: Lista selecionada de modelos fornecidos pelo LocalCode.
---
...
O LocalCode Zen é uma lista de modelos testados e verificados fornecidos pela equipe do LocalCode.

:::note
O LocalCode Zen está atualmente em beta.
:::

O Zen funciona como qualquer outro provedor no LocalCode. Você faz login no LocalCode Zen e obtém sua chave de API. É **completamente opcional** e você não precisa usá-lo para utilizar o LocalCode.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o LocalCode.
:::
...
O LocalCode Zen é um gateway de IA que lhe dá acesso a esses modelos.

---

## Como funciona

O LocalCode Zen funciona como qualquer outro provedor no LocalCode.

1. Você faz login no **<a href={console}>LocalCode Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona LocalCode Zen e cola sua chave de API.
...
O [id do modelo](/docs/config/#models) na sua configuração do LocalCode usa o formato `localcode/<model-id>`. Por exemplo, para GPT 5.2 Codex, você usaria `localcode/gpt-5.2-codex` na sua configuração.
...
- MiniMax M2.5 Free está disponível no LocalCode por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo oculto que está gratuito no LocalCode por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
...
4. Não ter **vinculação** permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o LocalCode também.
