---
title: Teilen
description: Teile LocalCode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu LocalCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht LocalCode Folgendes:
...
LocalCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt LocalCode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`localcode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du localcode in deiner Organisation einsetzt.
