---
title: TUI
description: Arbeite mit LocalCode in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LocalCode bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet LocalCode die TUI im aktuellen Verzeichnis.
...
In der LocalCode-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu LocalCode hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet LocalCode. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `localcode.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `LOCALCODE_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
