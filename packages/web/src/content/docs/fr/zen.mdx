---
title: Zen
description: Liste organisée de modèles fournis par LocalCode.
---
...
LocalCode Zen est une liste de modèles testés et vérifiés fournie par l'équipe LocalCode.

:::note
LocalCode Zen est actuellement en version bêta.
:::

Zen fonctionne comme n'importe quel autre fournisseur dans LocalCode. Vous vous connectez à LocalCode Zen et obtenez votre clé API. C'est **complètement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser LocalCode.
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec LocalCode.
:::
...
LocalCode Zen est une passerelle IA qui vous donne accès à ces modèles.

---

## Comment ça marche

LocalCode Zen fonctionne comme n'importe quel autre fournisseur dans LocalCode.

1. Vous vous connectez à **<a href={console}>LocalCode Zen</a>**, ajoutez vos informations de facturation et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez LocalCode Zen et collez votre clé API.
...
| ------------------ | ------------------ | -------------------------------------------------- | --------------------------- |
| GPT 5.4            | gpt-5.4            | `https://localcode.dev/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.3 Codex      | gpt-5.3-codex      | `https://localcode.dev/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.2            | gpt-5.2            | `https://localcode.dev/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.2 Codex      | gpt-5.2-codex      | `https://localcode.dev/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1            | gpt-5.1            | `https://localcode.dev/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex      | gpt-5.1-codex      | `https://localcode.dev/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex Max  | gpt-5.1-codex-max  | `https://localcode.dev/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex Mini | gpt-5.1-codex-mini | `https://localcode.dev/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5              | gpt-5              | `https://localcode.dev/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5 Codex        | gpt-5-codex        | `https://localcode.dev/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5 Nano         | gpt-5-nano         | `https://localcode.dev/zen/v1/responses`             | `@ai-sdk/openai`            |
| Claude Opus 4.6    | claude-opus-4-6    | `https://localcode.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.5    | claude-opus-4-5    | `https://localcode.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.1    | claude-opus-4-1    | `https://localcode.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4.6  | claude-sonnet-4-6  | `https://localcode.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4.5  | claude-sonnet-4-5  | `https://localcode.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4    | claude-sonnet-4    | `https://localcode.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Haiku 4.5   | claude-haiku-4-5   | `https://localcode.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Haiku 3.5   | claude-3-5-haiku   | `https://localcode.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Gemini 3.1 Pro     | gemini-3.1-pro     | `https://localcode.dev/zen/v1/models/gemini-3.1-pro` | `@ai-sdk/google`            |
| Gemini 3 Pro       | gemini-3-pro       | `https://localcode.dev/zen/v1/models/gemini-3-pro`   | `@ai-sdk/google`            |
| Gemini 3 Flash     | gemini-3-flash     | `https://localcode.dev/zen/v1/models/gemini-3-flash` | `@ai-sdk/google`            |
| MiniMax M2.5       | minimax-m2.5       | `https://localcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.5 Free  | minimax-m2.5-free  | `https://localcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.1       | minimax-m2.1       | `https://localcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 5              | glm-5              | `https://localcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.7            | glm-4.7            | `https://localcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.6            | glm-4.6            | `https://localcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2.5          | kimi-k2.5          | `https://localcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2 Thinking   | kimi-k2-thinking   | `https://localcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2            | kimi-k2            | `https://localcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3 Coder 480B   | qwen3-coder        | `https://localcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Big Pickle         | big-pickle         | `https://localcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

Le [id du modèle](/docs/config/#models) dans votre configuration LocalCode utilise le format `localcode/<model-id>`. Par exemple, pour GPT 5.2 Codex, vous devez utilisez `localcode/gpt-5.2-codex` dans votre configuration.
...
```
https://localcode.dev/zen/v1/models
```
...
- MiniMax M2.5 Free est disponible sur LocalCode pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- Big Pickle est un modèle furtif gratuit sur LocalCode pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
...
Nous avons créé LocalCode Zen pour :
...
4. N'ayez **aucun verrouillage** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et laissez-vous toujours utiliser n'importe quel autre fournisseur avec LocalCode également.
