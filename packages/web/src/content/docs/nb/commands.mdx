...
Opprett `.localcode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom LocalCode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i LocalCode [config](/docs/config):
...
- Per prosjekt: `.localcode/commands/`
...
LocalCode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
