...
Agentferdigheter lar LocalCode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går localcode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
localcode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `localcode.json`:
