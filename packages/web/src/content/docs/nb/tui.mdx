---
title: TUI
description: Bruke localcode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LocalCode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre LocalCode starter TUI for gjeldende katalog.
...
Når du bruker LocalCode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til LocalCode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt LocalCode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `localcode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `LOCALCODE_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
