---
title: Zen
description: Utvalgt liste over modeller levert av LocalCode.
---
...
LocalCode Zen er en liste over testede og verifiserte modeller levert av LocalCode-teamet.

:::note
LocalCode Zen er for øyeblikket i beta.
:::

Zen fungerer som alle andre leverandører i LocalCode. Du logger på LocalCode Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med LocalCode.
:::
...
LocalCode Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

LocalCode Zen fungerer som alle andre leverandører i LocalCode.

1. Du logger på **<a href={console}>LocalCode Zen</a>**, legg til fakturering
   detaljer, og kopier API-nøkkelen.
2. Du kjører kommandoen `/connect` i TUI, velger LocalCode Zen og limer inn API-nøkkelen.
...
[modell-id](/docs/config/#models) i LocalCode-konfigurasjonen
bruker formatet `localcode/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruk `localcode/gpt-5.2-codex` i konfigurasjonen din.
...
- MiniMax M2.5 Free er tilgjengelig på LocalCode i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på LocalCode i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
...
Vi opprettet LocalCode Zen for å:
...
4. Ha **ingen låsing** ved å la deg bruke den med en hvilken som helst annen kodeagent. Og la deg alltid bruke en hvilken som helst annen leverandør med LocalCode også.
