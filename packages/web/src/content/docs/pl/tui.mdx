---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala localcode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

localcode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie localcode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI localcode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do localcode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij localcode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `localcode.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `LOCALCODE_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
