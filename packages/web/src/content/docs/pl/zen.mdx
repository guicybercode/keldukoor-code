---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez LocalCode.
---
...
LocalCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół LocalCode.

:::note
LocalCode Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w LocalCode. Logujesz się do LocalCode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z LocalCode.
:::
...
LocalCode Zen to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

LocalCode Zen działa jak każdy inny dostawca w LocalCode.

1. Logujesz się do **<a href={console}>LocalCode Zen</a>**, dodajesz dane rozliczeniowe
   i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz LocalCode Zen i wklejasz klucz API.
...
[Identyfikator modelu](/docs/config/#models) w konfiguracji LocalCode
używa formatu `localcode/<model-id>`. Na przykład w przypadku GPT 5.2 Codex użyłbyś
`localcode/gpt-5.2-codex` w swojej konfiguracji.
...
- MiniMax M2.5 Free jest dostępny w LocalCode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Big Pickle to ukryty model, który jest bezpłatny w LocalCode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
...
Stworzyliśmy LocalCode Zen, aby:
...
4. Nie **mieć blokady** (no lock-in), umożliwiając używanie go z dowolnym innym agentem kodującym. I zawsze pozwalać na korzystanie z dowolnego innego dostawcy w LocalCode.
