---
title: TUI
description: Brug af LocalCode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LocalCode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre LocalCode starter TUI for den nuværende mappe.
...
Når du bruger LocalCode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til LocalCode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut LocalCode. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `localcode.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `LOCALCODE_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
