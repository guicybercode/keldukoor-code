...
Brug den til at bygge integrasjoner og kontrollere localcode programmatisk.
...
Opret en forekomst av localcode:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `localcode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av localcode, kan du oprete en klientforekomst for at koble til den:
