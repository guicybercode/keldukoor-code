...
Opret `.localcode/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem LocalCode-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din LocalCode [config](/docs/config):
...
- Globalt: `~/.config/localcode/commands/`
- Pr. projekt: `.localcode/commands/`
...
localcode indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
