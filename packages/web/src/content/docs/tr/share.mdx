---
title: Paylasim
description: localcode konusmalarini genel baglantilarla paylasin.
---

localcode'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda localcode:
...
localcode, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak localcode manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `localcode.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda localcode kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
