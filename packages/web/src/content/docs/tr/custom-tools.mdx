---
title: Özel Araçlar
description: LLM'un localcode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. localcode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.localcode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/localcode/tools/` içine yerleştirerek.
