...
import { IconLocalcode } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "localcode/session/message-v2"
import type { Message } from "localcode/session/message"
import type { Session } from "localcode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.localcode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.localcode_name}>
                    <IconLocalcode width={16} height={16} />
                  </div>
