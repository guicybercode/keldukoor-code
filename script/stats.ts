...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/localcode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/localcode...\n")
...
console.log("Fetching npm all-time downloads for localcode...\n")
const npmDownloads = await fetchNpmDownloads("localcode")
